...
candidates:  ; python3 -m qr_research.lens.fdic_drafts && python3 -m qr_research.lens.gateway_drafts && python3 -m qr_research.lens.gateway_finance_drafts && python3 -m qr_research.lens.sec_form_d_drafts && python3 -m qr_research.lens.bankruptcy_drafts && python3 -m qr_research.lens.usaspending_drafts
